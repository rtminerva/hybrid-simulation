...
def move_left(sol,nom,xb,yb,list_prob_0,list_prob_1,ml,tip_l): #2.2.(2).(1)
    tipp = 'left'
...
def move_right(sol,nom,xb,yb,list_prob_0,list_prob_2,mr,tip_r): #2.2.(2).(2) 
    tipp = 'right'
    xpos_new = sol['matrix_tip'][nom][-1][0] + 2
    ypos_new = sol['matrix_tip'][nom][-1][1]
    sol['matrix_tip'][nom].append((xpos_new,ypos_new)) 
...
def move_down(sol,nom,xb,yb,list_prob_0,list_prob_3,md,tip_d): #2.2.(2).(3)
    tipp = 'down'
...
def move_up(sol,nom,xb,yb,list_prob_0,list_prob_4,mu,tip_u): #2.2.(2).(4)
    tipp = 'up'
    xpos_new = sol['matrix_tip'][nom][-1][0]
    ypos_new = sol['matrix_tip'][nom][-1][1] + 2
    sol['matrix_tip'][nom].append((xpos_new,ypos_new))
...
def movement(sol,nom,xb,yb,list_prob_0,list_prob_1,list_prob_2,list_prob_3,list_prob_4,ml,mr,md,mu,tip_l,tip_r,tip_d,tip_u): #2.2.(2)
    if nom in sol['pp']:
        tipp = 'stay'
        oo = 0
...
def move_left_branch(sol,xb,yb,list_prob_0,list_prob_1,ml,tip_l): #2.2.(5).(1)
    tipp = 'left'
...
def move_right_branch(sol,xb,yb,list_prob_0,list_prob_2,mr,tip_r): #2.2.(5).(2)
    tipp = 'right'
    xpos_new = sol['matrix_tip'][-1][-1][0] + 2
    ypos_new = sol['matrix_tip'][-1][-1][1]
    sol['matrix_tip'][-1].append((xpos_new,ypos_new)) 
...
def move_down_branch(sol,xb,yb,list_prob_0,list_prob_3,md,tip_d): #2.2.(5).(3)
    tipp = 'down'
...
def move_up_branch(sol,xb,yb,list_prob_0,list_prob_4,mu,tip_u): #2.2.(5).(4)
    tipp = 'up'
    xpos_new = sol['matrix_tip'][-1][-1][0]
    ypos_new = sol['matrix_tip'][-1][-1][1] + 2
    sol['matrix_tip'][-1].append((xpos_new,ypos_new))
...
def movement_branch(tipp,sol,xb,yb,list_prob_0,list_prob_1,list_prob_2,list_prob_3,list_prob_4,ml,mr,md,mu,tip_l,tip_r,tip_d,tip_u): #2.2.(5)
    tes = randint(1,10000)
    if tes in list_prob_0:
        tipp = 'stay'
    elif tes in list_prob_1:
        sol, tipp = move_left_branch(sol,xb,yb,list_prob_0,list_prob_1,ml,tip_l) #2.2.(5).(1)
    elif tes in list_prob_2:   
        sol, tipp = move_right_branch(sol,xb,yb,list_prob_0,list_prob_2,mr,tip_r) #2.2.(5).(2)
    elif tes in list_prob_3: 
        sol, tipp = move_down_branch(sol,xb,yb,list_prob_0,list_prob_3,md,tip_d) #2.2.(5).(3)
    elif tes in list_prob_4: 
        sol, tipp = move_up_branch(sol,xb,yb,list_prob_0,list_prob_4,mu,tip_u) #2.2.(5).(4)
    return sol, tipp
    ...
    for nom in range(0,n_sp): #dicek setiap tip
        if not nom in sol['sp_stop']: #kalo dia sudah anastomosis, gak perlu branching dan move lg.
            ...
            if dirr[1] == 0 and dirr[2] == 0 and dirr[3] == 0 and dirr[4] == 0:
                ...
                '''Checking Space for n #if meet vessel''' #not used
                ml = 'f'
                mr = 'f'
                md = 'f'
                mu = 'f'
                ...
                '''not using the following code for the moment'''
...
#                 PP = 'test'
#                 if tipp == 'stay' and PP == 'test': #not able to branch
