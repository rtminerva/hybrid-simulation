...
def pic_2d(coef,set,sol):           
    ...
    ax.pcolormesh(y_sub_axis, x_sub_axis, f_sol, vmin = 0.499, vmax = 0.504, cmap="BuPu")
    '''Tip Cell'''
    x_p = []
    y_p = []
    for tip in sol['tip_cell']:
    ...
    ax.pcolormesh(y_sub_axis, x_sub_axis, c_sol, vmin = 0.499, vmax = 0.504, cmap="BuPu")
    '''tip cell'''
    x_p = []
    y_p = []
    for tip in sol['tip_cell']:
    ...
    ax.pcolormesh(y_sub_axis, x_sub_axis, cn_sol, vmin = 0.499, vmax = 0.504, cmap="BuPu")
    '''tip cell'''
    x_p = []
    y_p = []
    for tip in sol['tip_cell']:
