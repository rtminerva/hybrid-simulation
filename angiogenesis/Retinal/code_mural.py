def vx_code(h1 = 0, cc = 0, x_p = 0, y_p = 0): #at main lattice
    r = 0.5/h1*(cc[x_p+1,y_p+1]-cc[x_p-1,y_p+1]+cc[x_p+1,y_p-1]-cc[x_p-1,y_p-1])
    return r
    
def vy_code(h1 = 0, cc = 0, x_p = 0, y_p = 0): #at main lattice
    r = 0.5/h1*(cc[x_p+1,y_p+1]+cc[x_p-1,y_p+1]-cc[x_p+1,y_p-1]-cc[x_p-1,y_p-1])
    return r
    
def wx_code(h1 = 0, ff = 0, x_p = 0, y_p = 0): #at main lattice
    r = 0.5/h1*(ff[x_p+1,y_p+1]-ff[x_p-1,y_p+1]+ff[x_p+1,y_p-1]-ff[x_p-1,y_p-1])
    return r

def wy_code(h1 = 0, ff = 0, x_p = 0, y_p = 0): #at main lattice
    r = 0.5/h1*(ff[x_p+1,y_p+1]+ff[x_p-1,y_p+1]-ff[x_p+1,y_p-1]-ff[x_p-1,y_p-1])
    return r
