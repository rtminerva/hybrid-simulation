    ...
    for y in range(0,set['Ny']+1,2):
        for x in range(0,set['Nx']+1,2):           
            ...
            if r_f <= (set['R_min']**2 + set['error'] + set['Hh']):
                if x >= sol['matrix_tip'][2][0][0] and y >= sol['matrix_tip'][0][0][1]: #area 1
                    ...
                    if not coef['Mic'] == 0 or not coef['Kappa'] == 0:
                        ...
                        if coef['Ang2'] == False: ## Without Ang2
                            sol['p'][x,y] = (coef['A_p']*m_bool+coef['B_p'])*n_bool*n_stacks*sol['tp'] #Ang1
                        else:
                            sol['p'][x,y] = n_bool*n_stacks*sol['tp']/(coef['A_p']*m_bool+coef['B_p']) + p_o[x,y]*(1-coef['Dl']*sol['tp']) #Ang2
                            
                    c[x,y] = c_o[x,y]*(1 - sol['tp']*coef['Nu']*n_bool*n_tip) + coef['D_c']*sol['tp']/set['h']**2*(c_o[x+2,y]+c_o[x,y+2]-2*c_o[x,y])
                ...
                if x == 0:
                    c[x,y] = c_o[x,y]*(1 - sol['tp']*coef['Nu']*sol['n'][1,1]*n_tip)+ coef['D_c']*sol['tp']/set['h']**2*(c_o[x+2,y]+c_o[x,y+2]-2*c_o[x,y])
                    f[x,y] = f_o[x,y] + sol['tp']*coef['Beta']*sol['n'][1,1]*n_tip - sol['tp']*coef['Gama']*f_o[x,y]*sol['n'][1,1]*n_tip
                    
                    if not coef['Mic'] == 0 or not coef['Kappa'] == 0:
                        if coef['Ang2'] == False:
                            sol['p'][x,y] = (coef['A_p']*sol['m'][1,1]+coef['B_p'])*sol['n'][1,1]*n_stacks*sol['tp'] #Ang1
                        else:
                            sol['p'][x,y] = sol['n'][1,1]*n_stacks*sol['tp']/(coef['A_p']*sol['m'][1,1]+coef['B_p']) + p_o[x,y]*(1-coef['Dl']*sol['tp']) #Ang2   
                                                 
                elif x == Nx:
                    c[x,y] = c_o[x,y]*(1 - sol['tp']*coef['Nu']*sol['n'][Nx-1,1]*n_tip)+ coef['D_c']*sol['tp']/set['h']**2*(c_o[x-2,y]+c_o[x,y+2]-2*c_o[x,y])
                    f[x,y] = f_o[x,y] + sol['tp']*coef['Beta']*sol['n'][Nx-1,1]*n_tip - sol['tp']*coef['Gama']*f_o[x,y]*sol['n'][Nx-1,1]*n_tip
                    
                    if not coef['Mic'] == 0 or not coef['Kappa'] == 0:
                        if coef['Ang2'] == False:
                            sol['p'][x,y] = (coef['A_p']*sol['m'][Nx-1,1]+coef['B_p'])*sol['n'][Nx-1,1]*n_stacks*sol['tp'] #Ang1
                        else:
                    ...
                    c[x,y] = c_o[x,y]*(1 - sol['tp']*coef['Nu']*n_bool*n_tip)+ coef['D_c']*sol['tp']/set['h']**2*(c_o[x+2,y]+c_o[x-2,y]+c_o[x,y+2]-3*c_o[x,y])
                    f[x,y] = f_o[x,y] + sol['tp']*coef['Beta']*n_bool*n_tip - sol['tp']*coef['Gama']*f_o[x,y]*n_bool*n_tip
                    
                
            elif y == Ny:
                if x == 0:
                    c[x,y] = c_o[x,y]*(1 - sol['tp']*coef['Nu']*sol['n'][1,Ny-1]*n_tip)+ coef['D_c']*sol['tp']/set['h']**2*(c_o[x+2,y]+c_o[x,y-2]-2*c_o[x,y])
                    f[x,y] = f_o[x,y] + sol['tp']*coef['Beta']*sol['n'][1,Ny-1]*n_tip - sol['tp']*coef['Gama']*f_o[x,y]*sol['n'][1,Ny-1]*n_tip
                    
                    if not coef['Mic'] == 0 or not coef['Kappa'] == 0:
                        if coef['Ang2'] == False:
                            sol['p'][x,y] = (coef['A_p']*sol['m'][1,Ny-1]+coef['B_p'])*sol['n'][1,Ny-1]*n_stacks*sol['tp'] #Ang1
                        else:
                            sol['p'][x,y] = sol['n'][1,Ny-1]*n_stacks*sol['tp']/(coef['A_p']*sol['m'][1,Ny-1]+coef['B_p']) + p_o[x,y]*(1-coef['Dl']*sol['tp']) #Ang2
                    
                elif x == Nx:
                    c[x,y] = c_o[x,y]*(1 - sol['tp']*coef['Nu']*sol['n'][Nx-1,Ny-1]*n_tip)+ coef['D_c']*sol['tp']/set['h']**2*(c_o[x-2,y]+c_o[x,y-2]-2*c_o[x,y])
                    f[x,y] = f_o[x,y] + sol['tp']*coef['Beta']*sol['n'][Nx-1,Ny-1]*n_tip - sol['tp']*coef['Gama']*f_o[x,y]*sol['n'][Nx-1,Ny-1]*n_tip
                    
                    if not coef['Mic'] == 0 or not coef['Kappa'] == 0:
                        if coef['Ang2'] == False:
                            sol['p'][x,y] = (coef['A_p']*sol['m'][Nx-1,Ny-1]+coef['B_p'])*sol['n'][Nx-1,Ny-1]*n_stacks*sol['tp'] #Ang1
                        else:
                ...
                if x == 0:
                    ...
                    c[x,y] = c_o[x,y]*(1 - sol['tp']*coef['Nu']*n_bool*n_tip)+ coef['D_c']*sol['tp']/set['h']**2*(c_o[x+2,y]+c_o[x,y+2]+c_o[x,y-2]-3*c_o[x,y])
                    f[x,y] = f_o[x,y] + sol['tp']*coef['Beta']*n_bool*n_tip - sol['tp']*coef['Gama']*f_o[x,y]*n_bool*n_tip
                    ...
                    c[x,y] = c_o[x,y]*(1 - sol['tp']*coef['Nu']*n_bool*n_tip)+ coef['D_c']*sol['tp']/set['h']**2*(c_o[x+2,y]+c_o[x-2,y]+c_o[x,y+2]+c_o[x,y-2]-4*c_o[x,y])
                    f[x,y] = f_o[x,y] + sol['tp']*coef['Beta']*n_bool*n_tip - sol['tp']*coef['Gama']*f_o[x,y]*n_bool*n_tip
    return sol