...
def rec_1_tip(coef,set,sol): #2.1.2.(1)
    ...
    if y % 2 == 0:
        y += 1
    sol['matrix_tip'].append([[set['Nx']-1,y]]) #should be on main-lattice (odd numbers)
    sol['n'][set['Nx']-1,y] = 1
#     sol['b'][1,y] = 1
    #sol['b'][5,y] = 1
    #sol['b'][7,y] = 1
...
def rec_5_tip(coef,set,sol): #2.1.2.(2)
    ...
    if y % 2 == 0:
        y += 1
    sol['matrix_tip'].append([[set['Nx']-1,y-24]])
    sol['n'][set['Nx']-1,y-24] = 1
#     sol['b'][5,y-24] = 1
    sol['list_tip_movement'].append('start') #movement tip
    sol['life_time_tip'].append(0) #lifetime
    ...
    if y1 % 2 == 0:
        y1 += 1
    sol['matrix_tip'].append([[set['Nx']-1,y1-14]])
    sol['n'][set['Nx']-1,y1-14] = 1
#     sol['b'][5,y1-14] = 1
    sol['list_tip_movement'].append('start') #movement tip
    sol['life_time_tip'].append(0) #lifetime
    ...
    if y2 % 2 == 0:
        y2 += 1
    sol['matrix_tip'].append([[set['Nx']-1,y2]])
    sol['n'][set['Nx']-1,y2] = 1
#     sol['b'][5,y2] = 1
    sol['list_tip_movement'].append('start') #movement tip
    sol['life_time_tip'].append(0) #lifetime
    ...
    if y2 % 2 == 0:
        y2 += 1
    sol['matrix_tip'].append([[set['Nx']-1,y2+14]])
    sol['n'][set['Nx']-1,y2+14] = 1
#     sol['b'][5,y2+14] = 1
    sol['list_tip_movement'].append('start') #movement tip
    sol['life_time_tip'].append(0) #lifetime
    ...
    if y2 % 2 == 0:
        y2 += 1
    sol['matrix_tip'].append([[set['Nx']-1,y2+24]])
    sol['n'][set['Nx']-1,y2+24] = 1
#     sol['b'][5,y2+24] = 1
    sol['list_tip_movement'].append('start') #movement tip
    sol['life_time_tip'].append(0) #lifetime
