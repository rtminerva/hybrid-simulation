...
def vector_B(theta = 0.5, time_step = 0.1, h2 = 0.005, ro1 = 0, X = 1, Y = 1, ccc = 0, fff = 0, left = False):
    ...
    if left == True: # I + matrix
        ...
        x1 = 1
        i = 0
        B[i] = 1 + (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
        for x1 in range(3,Nx-1,2):
            i += 1
            B[i] = 1 + (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
        
        x1 = Nx-1
        B[i+1] = 1 + (P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
        
        '''Inside'''
        for j, y1 in enumerate(range(3,Ny-1,2)):
            x1 = 1
            i = 0
            B[(i+Nx/2)+j*Nx/2] = 1 + (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1) + P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1) + P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
            for x1 in range(3,Nx-1,2):
                i += 1
            ...
            x1 = Nx-1
            B[(i+1+Nx/2)+j*Nx/2] = 1 + (P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1) + P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1) + P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
        '''Up side'''
        y1 = Ny-1
        x1 = 1
        i = 0
        B[i+(Nx/2)**2-Nx/2] = 1 + (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
        for x1 in range(3,Nx-1,2):
            i += 1
            B[i+(Nx/2)**2-Nx/2] = 1 + (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
        x1 = Nx-1
        B[i+1+(Nx/2)**2-Nx/2] = 1 + (P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
        ...
        x1 = 1
        i = 0
        B[i] = 1 - (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam
        for x1 in range(3,Nx-1,2):
            i += 1
            B[i] = 1 - (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam
        
        x1 = Nx-1
        B[i+1] = 1 - (P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam
        
        '''Inside'''
        for j, y1 in enumerate(range(3,Ny-1,2)):
            x1 = 1
            i = 0
            B[(i+Nx/2)+j*Nx/2] = 1 - (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1) + P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1) + P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam
            for x1 in range(3,Nx-1,2):
                i += 1
            ...
            x1 = Nx-1
            B[(i+1+Nx/2)+j*Nx/2] = 1 - (P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1) + P3_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1) + P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam
        '''Up side'''
        y1 = Ny-1
        x1 = 1
        i = 0
        B[i+(Nx/2)**2-Nx/2] = 1 - (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam
        for x1 in range(3,Nx-1,2):
            i += 1
            B[i+(Nx/2)**2-Nx/2] = 1 - (P1_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam
        x1 = Nx-1
        B[i+1+(Nx/2)**2-Nx/2] = 1 - (P2_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1)+P4_code(x = x1, y = y1, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam
    ...
    if left == True: # I + matrix
        for j in range(1,Ny-1,2):
            for i, x1 in enumerate(range(1,Nx,2)):
                D[i] = (-P4_code(x = x1, y = i, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
    else: # I - matrix
        for j in range(1,Ny-1,2):
            for i, x1 in enumerate(range(1,Nx,2)):
                D[i] = (-P4_code(x = x1, y = i, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam*(-1)  
    kk = Nx/2
...
def vector_E(theta = 0.5, time_step = 0.1, h2 = 0.005, ro1 = 0, X = 1, Y = 1, ccc = 0, fff = 0, left = False):
    ...
    if left == True: # I + matrix
        for j in range(3,Ny,2):
            for i, x1 in enumerate(range(1,Nx,2)):
                E[i] = (-P3_code(x = x1, y = j, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*theta*lam
    else: # I - matrix
        for j in range(3,Ny,2):
            for i, x1 in enumerate(range(1,Nx,2)):
                E[i] = (-P3_code(x = x1, y = j, c1 = ccc, f1 = fff, h1 = h2, ro2 = ro1))*(1-theta)*lam*(-1)
    kk = Nx/2
